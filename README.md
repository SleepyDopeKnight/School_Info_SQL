...
1. [Chapter I](#chapter-i) \
   ...
   1.2. [Logical view of database model](#logical-view-of-database-model)
2. [Chapter II](#chapter-ii) \
   ...
   2.4. [Part 4. Metadata](#part-4-metadata)
...
Write a *Database_creation_part1.sql* script that creates the database and all the tables described above.
...
Create a *Changing_data_part2.sql* script, in which, in addition to what is described below, add test queries/calls for each item.
...
Create a *Getting_data_part3.sql* script, in which you should include the following procedures and functions
...
Add the creation and filling of this database, as well as the written procedures, to the *Metadata_part4.sql* file.
