...
1. [Chapter I](#chapter-i) \
    1.1. [Основные правила](#основные-правила) \
    1.2. [Логическое представление модели базы данных](#логическое-представление-модели-базы-данных)
2. [Chapter II](#chapter-ii) \
    ...
    2.4. [Part 4. Метаданные](#part-4-метаданные)


## Chapter I
## Основные правила

- Используйте эту страницу как единственную ссылку. Не слушайте никаких слухов и домыслов о том, как подготовить решение.
...
- Вы не должны оставлять в своем каталоге никаких дополнительных файлов, кроме sql-скриптов и csv-файлов. Рекомендуется изменить свой `.gitignore` во избежание несчастных случаев.
- У вас есть вопрос? Задайте его своему соседу справа. В противном случае попробуйте обратиться к соседу слева.
- Ваше справочное руководство: сверстники / Интернет / Google.
- И да пребудет с вами сила SQL!
- Абсолютно все можно представить на SQL! Давайте начнем и повеселимся!
...
Напишите скрипт *Database_creation_part1.sql*, создающий базу данных и все таблицы, описанные выше. 
...
Создайте скрипт *Changing_data_part2.sql*, в который, помимо описанного ниже, внесите тестовые запросы/вызовы для каждого пункта.
...
Создайте скрипт *Getting_data_part3.sql*, в который внесите описанные далее процедуры и функции 
...
Создание и заполнение этой базы данных, а также написанные процедуры, внести в файл *Metadata_part4.sql*.
